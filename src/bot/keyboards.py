...
user_kb = ReplyKeyboardMarkup(
    keyboard=[
        [KeyboardButton(text="Цель"), KeyboardButton(text="Статистика")],
...
goal_update_kb = ReplyKeyboardMarkup(
    keyboard=[[KeyboardButton(text="Обновить цель"), KeyboardButton(text="Главное меню")]],
    resize_keyboard=True,
)

goal_set_kb = ReplyKeyboardMarkup(
    keyboard=[[KeyboardButton(text="Задать цель"), KeyboardButton(text="Главное меню")]],
    resize_keyboard=True,
)
